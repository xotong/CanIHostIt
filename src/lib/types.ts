...
export interface ModelEntry {
  ...
  tierAllocationPercent: number; // % of peak-active users routed to this tier
  agenticMultiplier: number;     // per-tier parallel request multiplier
}
